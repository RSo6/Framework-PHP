        ...
        <div class="col-md-8 order-md-1">
            ...
            <ul class="thumbnails list-unstyled clearfix">
                <li class="thumb-main text-center"><a class="thumbnail" href="<?php echo PATH . $product['img'] ?>"
                                ...
                                src="<?php echo PATH . $product['img'] ?>" alt=""></a></li>

                <?php if (!empty($gallery)): ?>
                <?php foreach ($gallery as $item): ?>
                <li class="thumb-additional"><a class="thumbnail" href="<?php echo PATH . $item['img'] ?>"
                                                data-effect="mfp-zoom-in"><img src="<?php echo $item['img'] ?>" alt=""></a>
                </li>
                <?php endforeach; ?>
                <?php endif; ?>
            </ul>
