...
/*            for ($i = 0; $i < count($slides); $i++): */?>
                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="<?php
/*                echo $i */?>" <?php
/*                if ($i == 0) echo 'class="active"' */?> aria-current="true" aria-label="Slide <?php
/*                echo $i */?>"></button>
            <?php
/*            endfor; */?>
        </div>
...
/*                if ($i == 1) echo 'active' */?> ">
                    <img src="<?php
/*                    echo PATH . $slide->img */?>" class="d-block w-100" alt="">
                </div>
                <?php
/*                $i++; endforeach; */?>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="service-item">
                    ...
                    <p>Пряммі поставки від виробників</p>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="service-item">
                    ...
                    <p>Приємні і конкурентні ціни</p>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="service-item">
                    ...
                    <p>Профессійна консультація і сервіс</p>
                </div>
            </div>
