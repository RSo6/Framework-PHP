        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="service-item">
                    ...
                    <p><?php __('main_index_delivery_from_factory') ?></p>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="service-item">
                    ...
                    <p><?php __('main_index_wide_assortment_of_products')?></p>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="service-item">
                    ...
                    <p><?php __('main_index_pleasant_and_competitive_prices') ?></p>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="service-item">
                    ...
                    <p><?php __('main_index_professional_consultation_service') ?></p>
                </div>
            </div>
