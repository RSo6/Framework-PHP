...
<aside class="main-sidebar sideba   r-dark-primary elevation-4">
    <!-- Brand Logo -->
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?php echo PATH ?>/adminlte/dist/img/user2-160x160.jpg"
                        class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
                <a href="<?php echo ADMIN ?>/user/edit?id=<?php echo $_SESSION['user']['id'] ?>"
                   class="d-block"><?php echo h($_SESSION['user']['name']) ?></a>
        ...
        <!-- /.sidebar-menu -->
        <div class="info">
            <a href="<?php echo ADMIN ?>/user/logout" class="d-block">Log Out</a>
        </div>
    </div>
    <!-- /.sidebar -->
</aside>
